...
const accountWebRouter = require("./routes/web/accounts");
const accountApiRouter = require("./routes/api/accounts");
...
app.use((req, res, next) => {
  console.log(
    `[${new Date().toLocaleTimeString()}] ${req.method} ${req.get("host")} ${
      req.path
    }`
  );
  next();
